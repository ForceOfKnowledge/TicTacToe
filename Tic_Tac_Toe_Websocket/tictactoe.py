...
# TODO when both players move and one rejoins and does the same move again the move shjows only for the player who reconnected
# TODO when multiple users use the same gamepiece they can play for everyone else
...
if __name__ == "__main__":
    ...
    #port=1883
    #now using websocket mqtt client
    port=8080
    ...
    try:
        ...
        exit(1)
    topic = "/game/tictactoe/team"+str(team_nr)
